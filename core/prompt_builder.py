...
class PromptBuilder:
    ...
    def _question_style_guidance(self, question_style: str) -> list[str]:
        mapping = {
            ...
            "빈칸 채우기": [
                "모든 문항은 빈칸 채우기로 작성하라.",
                "핵심 단어나 어절을 ( )로 비우고, 한 문항에 한두 개만 비워라.",
                "답은 지문에 실제로 나오는 표현이어야 한다.",
                "각 문항 바로 뒤에 '[정답] 단어1, 단어2' 형식으로 답을 달아라.",
            ],
            "OX 진위 판단": [
                "모든 문항은 진위 판단형으로 작성하고, 문장 끝에 '(○, ✕)'를 붙여라.",
                "거짓 문장은 지문의 진술을 미묘하게 뒤집어 만들어라. 명백히 틀린 문장만 늘어놓지 마라.",
                "각 문항 바로 뒤에 '[정답] ✕ [해설] N문단에서 …' 형식으로 답과 근거 문단을 밝혀라.",
            ],
            "객관식·단답형·서술형 혼합": [
